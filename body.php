			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=20"><div class="shop">
							<div class="shop-img">
								<img src="./img/hp.jpg" alt="" style="margin-top: 120px;">
							</div>
							<div class="shop-body">
								<h3>Laptop<br>Collection</h3>
								<a href="product.php?p=20" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<!-- shop -->
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=39"><div class="shop">
							<div class="shop-img">
								<img src="./product_images/10052800-may-anh-canon-eos-r10-kit-18-45mm-stm-1.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Cameras<br>Collection</h3>
								<a href="product.php?p=39" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
					<!-- /shop -->
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Labtop</a></li>
									<li><a data-toggle="tab" href="#tab2">Mobile</a></li>
